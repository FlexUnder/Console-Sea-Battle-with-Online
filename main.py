...
def preparation_phase(field, connection):  # Фаза подготовки
    ...
    while list(ships_in_stock.values()) != [0] * 4:
        ...
        print('\n\t Фаза подготовки')
        print_field(field)
        print('Правила: Расставляйте корабли так, чтобы между ними была хотя бы одна клетка, и по очереди называйте координаты для выстрела, чтобы уничтожить флот противника')
